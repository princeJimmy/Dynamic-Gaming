...
def analytical_best_response(
    ...
    """Projected analytical best response, Eq. (44) in the paper."""
...
# 3. Sensitivity routine (1x3 figure focused on Table 2)
...
# 4. Run All Three Sensitivity Analyses (ranges aligned with Section 5.3)
